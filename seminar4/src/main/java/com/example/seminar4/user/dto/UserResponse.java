...
public class UserResponse {
    ...
    public static class ReadUser{
        ...
        public static ReadUser from(User user){
            return new ReadUser(user.getName(),BookResponse.BookReadResponse.bookToDto(user.getBook()));
        }
        public static ReadUser of(User user){
            return ReadUser.builder().name(user.getName()).books(BookResponse.BookReadResponse.bookToDto(user.getBook())).build();
        }
    }
